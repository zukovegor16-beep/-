...
Где весь минус, а где узкие 782: `MINUS-LIST.md`.
...
Подробный разбор, что в первом, втором и «крайнем» хвосте: `blacklist/triage/README.md`.

Коротко: список 1 = рабочая ссылка (кино, репозиторий, даже вредоносный парсер). Список 2 = пустой скам. Крайний = не классифицированный РКН, пачкой не удалять.
